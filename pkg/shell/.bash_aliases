...
alias vrc='vim $HOME/src/shrc/pkg/vim/.vimrc'
alias brc='vim $HOME/src/shrc/pkg/shell/.bashrc'
alias tree='exa -T'
alias oal='open-at-line'
...
alias yay-upg-list='yay -Sy && yay --color always -Qyu | sort | column -t'
